  !call main_1(2) !1-���������, 2-1/r^^3, 3-Ar+b1
  !call main_2
  !call main_3(2) !1-�������� � �������, ������ ��� ������������, 2-����������
...
subroutine main_1_3(g)
  ...
  call pg_allocate_bounds(1)
  call pg_bind_bound(1)
  call init_geom_1(g+1)!2-������� � ������ ���������� �1, 3-������� � ������ ���������� �2
  call pg_geom_postprocessor
  call init_gu_1(g+1)!2-������� � ������ ���������� �1, 3-������� � ������ ���������� �2
  ...
  call pg_allocate_bounds(1)
  call pg_bind_bound(1)
  call init_geom_2(g+1)!2-������� � ������ ���������� �1, 3-������� � ������ ���������� �2
  call pg_geom_postprocessor
  call init_gu_2(g+1)!2-������� � ������ ���������� �1, 3-������� � ������ ���������� �2
  
  call ga_drw_trmesh(0)
  call pg_get_matrix
  call closing_2(g+1)!1-������� � ��������, ������ ������� � ��������� �������� ��� 2-������� � ������ ���������� �1, 3-������� � ������ ���������� �2
  call closing_3(g)!1-������� � ������ ���������� �1, 2-������� � ������ ���������� �2
  call pg_solve
  call pg_get_psioml
  call compute_pressure(1)
  call draw_square(g)!1-������� � ������ ���������� �1, 2-������� � ������ ���������� �2
  !call print_fi_const(pi*0.5,2)
  !call print_psi_omega
  call pg_finish
  end
